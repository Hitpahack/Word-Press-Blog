...
document.addEventListener("DOMContentLoaded", function () {
    document.querySelectorAll(".editinline").forEach(button => {
        button.addEventListener("click", function () {
            document.querySelectorAll("#edit-345").forEach(row => {
                row.style.display = "table-row"; // Show all edit rows
            });
        });
    });
    ...
    document.querySelectorAll(".cancel").forEach(button => {
        button.addEventListener("click", function () {
            document.querySelectorAll("#edit-345").forEach(row => {
                row.style.display = "none"; // Hide all edit rows
            });
        });
    });
});
