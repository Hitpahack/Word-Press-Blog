...
namespace WP.Repository
{
    ...
    public interface IRepository<TEntity>: IDisposable,  IRepoPageList<TEntity>, ISingleFirstOrDefault<TEntity> 
        ...
        
    {
        ...
        TResult SqlQueryRawSingle<TResult>(string query, params MySqlParameter[] parameters); 
        IList<TResult> SqlQueryRawList<TResult>(string query, params MySqlParameter[] parameters);
